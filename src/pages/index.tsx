      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#0b3bd6] to-[#f8a221]">
        <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16 ">
          ...
          <div className="text-lg text-2xl font-bold text-white">
            Our new app uses GPT-3 technology to generate human-like text for a
            ...
            your text or query and let your agent take care of the rest. You'll
            be amazed at how accurate and natural the generated text is. Give it
            a try and experience the power of GPT-3 for yourself!
          </div>
